...
if __name__ == "__main__":
    ...
    correcttimedepature,correcttimearrival,previoustimedepature,previoustimearrival=details.split_availabletrain(boardingStations,arrivalStations,boardstations, endstations,arrivaltime)
